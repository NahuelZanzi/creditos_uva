...
#dolares
oficial = st.cache_data(ttl=60)(lambda: requests.get("https://dolarapi.com/v1/dolares/oficial").json())()
blue = st.cache_data(ttl=60)(lambda: requests.get("https://dolarapi.com/v1/dolares/blue").json())()
uva = valor_uva
st.markdown(f"""
<style>
...
st.markdown(
    """
    <div style="position: fixed; left: 20px; top: 400px; background: white;
